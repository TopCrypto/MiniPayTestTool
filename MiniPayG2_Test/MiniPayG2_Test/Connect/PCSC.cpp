...
DWORD SCard_ApduExchang(UCHAR *pucCommand,USHORT usCommandLen,UCHAR *pucResond,USHORT *pusRespondLen)
{  
	DWORD dwResult = 0;
...
DWORD SCard_SendCommand(BYTE *pucCommand,USHORT usCommandLen,BYTE *pucResond,USHORT *pusRespondLen,BOOL bPassFlag)
{  
	DWORD dwResult = 0;
